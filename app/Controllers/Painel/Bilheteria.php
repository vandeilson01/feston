...
class Bilheteria extends PainelController
{
    ...
    public function __construct()
    {
		...
		$this->data['menu_active'] = 'bilheteria';
    }


	public function index()
	{
		return view($this->directory .'/bilheteria', $this->data);
	}

	public function dashboard()
	{
		return view($this->directory .'/bilheteria-dashboard', $this->data);
	}

	public function grid()
	{
		return view($this->directory .'/bilheteria-grid-assentos', $this->data);
	}

	public function ingresso()
	{
		return view($this->directory .'/bilheteria-ingresso', $this->data);
	}

	public function pagamentos()
	{
		return view($this->directory .'/bilheteria-pagamentos', $this->data);
	}

	public function relatorios()
	{
		return view($this->directory .'/bilheteria-relatorios', $this->data);
	}

	public function configuracoes()
	{
		$this->data['listFormaCobranca'] = $this->cfgAPP->getFormaCobrancaBilheteria();

		return view($this->directory .'/bilheteria-configuracoes', $this->data);
	}
	...
	public function listar()
	{
		...
		return view($this->directory .'/bilheteria-list', $this->data);
	}
