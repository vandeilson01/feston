...
class Bilheteria extends BaseController
{
	...
	{
		return view('bilheteria/index', $this->data);
	}

	public function grid()
	{
		return view('bilheteria/grid', $this->data);
	}

	public function qrcode()
	{
		return view('bilheteria/qrcode', $this->data);
	}

	public function validacao()
	{
		return view('bilheteria/validacao', $this->data);
	}
	
	public function doacoes()
	{
		return view('bilheteria/doacoes', $this->data);
	}
	
	public function workshops()
	{
		return view('bilheteria/workshops', $this->data);
	}
