							...
							<div class="" style="margin: 0 auto; height: calc(100% - 1.5rem) !important; width: 95%;">
								<div class="card card-default h-100 mb-4" style="padding: 12px !important;">
									...
									<div class="card-body" style="background-color: #ffffff; padding: .5rem 0rem;">
										...
										<div class="pt-2">
											<div class="mb-2" style="background-color: #d1d1d1; height: 240px; border-radius: 4px;">
												<!-- CAMERA -->
											</div>
										</div>
										...
										<div class="pt-2">
											<div class="d-grid">
												<a href="javascript:;" class="btn btn-secondary" style="border-radius: 4px;">Ler novo QRCode</a>
											</div>
										</div>
										...
										<div class="pt-2">
											<div class="row justify-content-center align-items-end g-2">
												<div class="col-12 col-md-7 text-center">
													<label class="text-center" style="font-size: 0.75rem;">Código Identificado</label>
													<div class="d-grid gap-2">
														<input type="text" id="numQRCode" value="" class="form-control text-center" style="height: auto !important; padding: .375rem .75rem !important; border-radius: 4px !important;">
													</div>
												</div>
												<div class="col-12 col-md-5">
													<div class="d-grid">
														<a href="<?php echo(site_url('bilheteria/validacao')); ?>" class="btn btn-warning" style="border-radius: 4px;">SALVAR</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card-footer d-none" style="background-color: #ffffff; padding: .5rem 0rem; border-top: 2px dashed #cfcfcf;">
										<div class="d-grid">
