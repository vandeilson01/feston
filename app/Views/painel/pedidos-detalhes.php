						...
						<div class="box-content">
							...
							<div class="row">
								<div class="col-12">
									...
									<input autoload type="hidden" name="pedidoid" id="pedidoid" class="form-control" value="<?php echo( (isset($rs_pedido->id) ? $rs_pedido->id : '') ); ?>" v-model="fieldpedido.pedidoid" />
					...
					<div class="card-body">
						<div class="box-content">
							<div class="gridBox">								
								...
								?>
								<div class="row justify-content-end align-items-center pt-2 <?php echo( (($count >= 2) ? 'mt-2' : '') ); ?>" style="<?php echo( $css_row ); ?>">
									<div class="col-12 col-md-6">
