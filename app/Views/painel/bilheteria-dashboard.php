						...
						<div class="card card-default mb-3">
							<div class="card-body py-3">
								...
								<div class="">
									...
									<div class="card card-resultitens active">
										<div class="card-body">
											<div class="d-flex ">
												<div class="container">
													<div class="row justify-content-between align-items-center mb-1">
														<div class="col-12 col-md-4">
															<h3 class="m-0">Pedido Número: #000125556</h3>
														</div>
															...
															<div class="d-grid">
																<div class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-end">
																		<li><a class="dropdown-item" href="#"><i class="las la-envelope-open-text" style="font-size: 18px;"></i> Reenviar e-mail de confirmação</a></li>
																		<li><a class="dropdown-item" href="<?php echo( painel_url('bilheteria/ingresso')) ?>"><i class="las la-print" style="font-size: 18px;"></i> Imprimir ingresso</a></li>
																		<li><a class="dropdown-item" href="#"><i class="las la-comment" style="font-size: 18px;"></i> Adicionar nota sobre pedido</a></li>
																	</ul>
																</div>
															</div>
														</div>
													...
													<div class="row justify-content-between align-items-start mb-1">
														<div class="col-12 col-md-4">
															<h3 class="mb-1 " style="font-weight: bold;">R$ 48,00</h3>
															<div style="line-height: 1.5; color: #8e8e8e;">Método de pagamento: <span style="font-weight: bold;">Mercado Pago</span></div>
															<div style="line-height: 1.5; color: #8e8e8e;">Tipo de Inscrição: <span style="font-weight: bold;">Amostra</span></div>
															<div style="line-height: 1.5; color: #8e8e8e;">Nome do Funcionário (Check-in): <span style="font-weight: bold;">Aloísio</span></div>
														</div>
														<div class="col-12 col-md-8">
															<div class="d-flex flex-column" style="line-height: 1.5;">
																<div style="font-weight: bold;">Viviane Almeida Soares</div>
																<div>21.05.2024</div>
																<div class="d-flex">
																	<span class="itemDots">Fez Check-in</span>
																	<span class="itemDots" style="font-weight: bold">SIM</span>
																	<span class="itemDots">21.05.2024 17h32</span>
																</div>
															</div>
														</div>
													</div>
									...
									<div class="card card-resultitens">
										<div class="card-body">
											<div class="d-flex ">
												<div class="container">
													<div class="row justify-content-between align-items-center mb-1">
														...
														<div class="col-12 col-md-2">
															...
															<div style="margin: 0 3px;">
																<a href="#" class="border-btn" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="more-vertical"></i> Ações</a>
															...
															<div class="form-group m-0">
																<select class="form-select form-select-sm" name="partc_genero" id="partc_genero">
																	<option value="" translate="no">Ações</option>
																	<option value="intermediario">Reenviar e-mail de confirmação</option>
																	<option value="avancado">Imprimir ingresso</option>
																	<option value="avancado">Adicionar nota sobre pedido</option>
																</select>
															</div>
															-->
														</div>
													...
													<div class="row justify-content-between align-items-start mb-1">
														<div class="col-12 col-md-4">
															<h3 class="mb-1 " style="font-weight: bold;">R$ 48,00</h3>
															<div style="line-height: 1.5; color: #8e8e8e;">Método de pagamento: <span style="font-weight: bold;">Mercado Pago</span></div>
															<div style="line-height: 1.5; color: #8e8e8e;">Tipo de Inscrição: <span style="font-weight: bold;">Workshop</span></div>
														</div>
														<div class="col-12 col-md-8">
															<div class="d-flex flex-column" style="line-height: 1.5;">
																<div style="font-weight: bold;">Roberta Patrício Candez</div>
																<div>21.06.2024</div>
															</div>
														</div>
													</div>
										...
										<div class="card-body">
											<div class="d-flex ">
												<div class="container">
													<div class="row justify-content-between align-items-center mb-1">
														<div class="col-12 col-md-4">
															<h3 class="m-0">Pedido Número: #000125590</h3>
														</div>
														<div class="col-12 col-md-5"></div>
														<div class="col-12 col-md-2">
															<div class="d-grid">
													...
													<div class="row justify-content-between align-items-start mb-1">
														...
														<div class="col-12 col-md-8">
															<div class="d-flex flex-column" style="line-height: 1.5;">
																<div style="font-weight: bold;">Augusto Pacheco da Silva</div>
																<div>21.07.2024</div>
															</div>
														</div>
													</div>
