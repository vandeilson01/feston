								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('generos')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="gene_titulo">Título</label>
													<input type="text" name="gene_titulo" id="gene_titulo" class="form-control" value="<?php echo((isset($rs_dados->gene_titulo) ? $rs_dados->gene_titulo : ""));?>" />
												</div>
											</div>
										</div>
