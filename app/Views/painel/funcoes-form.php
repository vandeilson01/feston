								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('funcoes')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									<div class="col-12 col-md-3">
										...
										<div class="row">
											<div class="col-12">
												<?php 
													$func_obrigatorio = (int)((isset($rs_dados->func_obrigatorio) ? $rs_dados->func_obrigatorio : "0")); 
													$obrigatorio_s = ($func_obrigatorio == "1" ? ' checked ' : '');
													$obrigatorio_n = ($func_obrigatorio != "1" ? ' checked ' : '');
												?>
												<div class="form-group">
													<div><label class="form-label" for="EMAIL">Função Obrigatória?</label></div>
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="func_obrigatorio" id="obrigatorio_s" class="custom-control-input" value="1" <?php echo($obrigatorio_s)?> />
																<label class="custom-control-label" for="obrigatorio_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="func_obrigatorio" id="obrigatorio_n" class="custom-control-input" value="0" <?php echo($obrigatorio_n)?> />
																<label class="custom-control-label" for="obrigatorio_n">Não</label>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-12">
												<?php 
													...
													$funcao_s = ($func_ativo == "1" ? ' checked ' : '');
													$funcao_n = ($func_ativo != "1" ? ' checked ' : '');
												?>
												<div class="form-group">
													...
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="func_ativo" id="funcao_s" class="custom-control-input" value="1" <?php echo($funcao_s)?> />
																<label class="custom-control-label" for="funcao_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="func_ativo" id="funcao_n" class="custom-control-input" value="0" <?php echo($funcao_n)?> />
																<label class="custom-control-label" for="funcao_n">Não</label>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="func_titulo">Título da Função</label>
