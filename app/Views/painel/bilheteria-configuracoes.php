...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Configurações da Bilheteria</h2>
			</div>
		</div>
	</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('bilheteria')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
							...
							<div class="card-body">
								...
								<ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
									<li class="nav-item" role="presentation">
										<a class="nav-link active" id="link-principal" data-bs-toggle="tab" href="#tb-principal" role="tab" aria-controls="tb-principal" aria-selected="true">Dados Principais</a>
									</li>
									
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="link-valores" data-bs-toggle="tab" href="#tb-valores" role="tab" aria-controls="tb-valores" aria-selected="false">Cobrança / Valores</a>
									</li>
									<li class="nav-item" role="presentation">
								...
								<div class="tab-content pt-3" id="ex1-content">
									...
									<div class="tab-pane fade show active" id="tb-principal" role="tabpanel" aria-labelledby="link-principal">
										<?php 
											$include = view('painel/widgets/bilheteria-form-principal', []);
											echo( $include );
										?>
									</div>
									...
									<div class="tab-pane fade" id="tb-valores" role="tabpanel" aria-labelledby="link-valores">
										<?php 
											$include = view('painel/widgets/bilheteria-form-valores', []);
											echo( $include );
										?>
									</div>

									<!-- COBRANCA -->
									<div class="tab-pane fade" id="tb-cobrancas" role="tabpanel" aria-labelledby="link-cobrancas">
										<?php 
									...
									<div class="tab-pane fade " id="tb-autorizacoes" role="tabpanel" aria-labelledby="link-autorizacoes">
										<?php 
											$include = view('painel/widgets/bilheteria-form-autorizacoes', []);
											echo( $include );
										?>
									</div>
