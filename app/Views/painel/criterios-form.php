...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Critérios</h2>
			</div>
		</div>
	</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('criterios')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									<div class="col-12 col-md-3">
										...
										<div class="row">
											<div class="col-12">
												<?php 
													$crit_ativo = (int)((isset($rs_dados->crit_ativo) ? $rs_dados->crit_ativo : "1")); 
													$criterio_s = ($crit_ativo == "1" ? ' checked ' : '');
													$criterio_n = ($crit_ativo != "1" ? ' checked ' : '');
												?>
													...
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="crit_ativo" id="criterio_s" class="custom-control-input" value="1" <?php echo($criterio_s)?> />
																<label class="custom-control-label" for="criterio_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="crit_ativo" id="criterio_n" class="custom-control-input" value="0" <?php echo($criterio_n)?> />
																<label class="custom-control-label" for="criterio_n">Não</label>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="crit_titulo">Título</label>
													<input type="text" name="crit_titulo" id="crit_titulo" class="form-control" value="<?php echo((isset($rs_dados->crit_titulo) ? $rs_dados->crit_titulo : ""));?>" />
												</div>
											</div>
										</div>
