				...
				<div class="row">
					<div class="col-12 col-md-3">
						<div class="form-group">
							<label class="form-label" for="crit_nota_min">Data</label>
							<select class="form-select form-select-sm" name="ordeData[]" id="ordeData_1">
									...
									<tbody>
										<tr class="trRow">
											<td class="text-center" style="width:70px;">
												<input type="checkbox" name="chkApresentacao[]" id="chkApresentacao_xx" value="2" checked="">
											</td>
											<td>
												Técnica 
											</td>
										...
										<tr class="trRow">
											<td class="text-center" style="width:70px;">
												<input type="checkbox" name="chkApresentacao[]" id="chkApresentacao_xx" value="2">
											</td>
											<td>
												Interpretação
											</td>
