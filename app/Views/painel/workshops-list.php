					...
					<div class="col-12 col-md-12">
						...
						<div class="card card-default">
							<div class="card-body py-3">
								...
								<div class="mb-5 pb-3" style="border-bottom: 1px dashed #d7d7d7;">
									...
									<div class="row align-items-end">
										...
										<div class="col-12 col-md-5">
											<div class="row align-items-end">
												<div class="col-12 col-md-4">
													<div class="form-group">
														<label class="form-label" for="curso_dte_inicio">Estado</label>
														<select class="form-select" name="partc_genero" id="partc_genero">
															<option value="" translate="no">- selecione -</option>
															<option value="iniciante">Iniciante</option>
															<option value="intermediario">Intermediário</option>
												...
												<div class="col-12 col-md-8">
													<div class="form-group">
														<label class="form-label" for="curso_dte_inicio">Cidade</label>
														<select class="form-select" name="partc_genero" id="partc_genero">
															<option value="" translate="no">- selecione -</option>
															<option value="iniciante">Iniciante</option>
															<option value="intermediario">Intermediário</option>
										...
										<div class="col-12 col-md">
											<div class="form-group">
												<div class="d-grid">
													<button type="button" class="btn btn-success" value="Salvar">Pesquisar</button>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="">
									<h4 class="text-center mb-3">WorkShops</h4>
