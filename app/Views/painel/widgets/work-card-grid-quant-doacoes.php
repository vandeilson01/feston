...
<div id="tipoCobraDoacao" class="tipoCobrancaCurso <?php echo( $checked_box ); ?>">
	<div class="card card-base TxtQtdDoacoes mb-3" style="border: 1.5px solid #ffe093 !important;">
