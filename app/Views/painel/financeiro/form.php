							...
							<div class="card-body">
								<ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
									<li class="nav-item" role="presentation">
										<a class="nav-link active" id="link-infos-pessoais" data-bs-toggle="tab" href="#tb-infos-pessoais" role="tab" aria-controls="tb-infos-pessoais" aria-selected="true">Fornecedores</a>
									</li>
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="link-infos-profissionais" data-bs-toggle="tab" href="#tb-infos-profissionais" role="tab" aria-controls="tb-infos-profissionais" aria-selected="false">Patrocinadores</a>
									</li>
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="link-infos-pagamento" data-bs-toggle="tab" href="#tb-infos-pagamento" role="tab" aria-controls="tb-infos-pagamento" aria-selected="false">Contas a Pagar</a>
									</li>
								</ul>
