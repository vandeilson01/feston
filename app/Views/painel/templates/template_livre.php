...
<head>
	...
	<link rel="shortcut icon" href="assets/media/logos/identificare-logo-icon.png" />
...
<body id="kt_body" style="background-image: url()" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled" data-kt-aside-minimize="on">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-extended" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<!--begin::Logo-->
						<div class="aside-logo d-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
							<a href="<?php echo( site_url() ); ?>">
								<img alt="Logo" src="assets/media/logos/identificare-logo-icon.png" class="h-35px" />
							</a>
						</div><!--end::Logo-->
							...
							<div class="hover-scroll-y mb-10" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="0px">
								...
								<ul class="nav flex-column">
									...
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Dashboard">
										<!--begin::Nav link-->
										<a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light" href="<?php echo( site_url('dashboard') ); ?>">
									...
									<!--begin:: Catracas -->
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Catracas">
										<!--begin::Nav link-->
										<a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light " href="<?php echo( site_url('catracas') ); ?>">
									...
									<!--begin:: Usuários -->
									<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Usuários">
										<!--begin::Nav link-->
										<a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light" href="<?php echo( site_url('usuarios') ); ?>">
						...
						<div class="aside-footer d-flex flex-column align-items-center flex-column-auto " id="kt_aside_footer">
							...
							<div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
								<!--begin::Menu wrapper-->
								<div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="Meu Perfil">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column" style="overflow: hidden;">
												<div class="fw-bolder d-flex align-items-center fs-5">
													<?php echo(session()->get('nome'))?>
													<!-- <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span> -->
												</div>
												<div>
													<span class="badge badge-light-success fw-bolder fs-8"><?php echo(session()->get('nivel'))?></span>
												</div>
												<div>
													<span class="badge badge-light-success fw-bolder fs-8"><?php echo(session()->get('evento'))?></span>
												</div>
												<!-- <a href="#" class="fw-bold text-muted text-hover-primary fs-7">marcio.misterlab.meuemailmaior@gmail.com</a> -->
											</div>
											<!--end::Username-->
										</div>
									</div>
									...
									<div class="d-none">
										...
										<div class="menu-item px-5">
											<a href="<?php echo( site_url('perfil') ); ?>" class="menu-link px-5">Meu Perfil</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="<?php echo( site_url('configuracoes') ); ?>" class="menu-link px-5">Configurações</a>
										</div>
										<!--end::Menu item-->

										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="<?php echo( site_url('plano') ); ?>" class="menu-link px-5">Plano</a>
										</div>
										<!--end::Menu item-->
									</div>
					...
					<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
						...
						<!--begin::Secondary-->
						<div class="aside-secondary d-flex flex-row-fluid" style="display:none !important;">
							<!--begin::Workspace-->
					...
					<!--begin::Aside Toggle-->
					<button class="btn btn-sm btn-icon bg-body btn-color-gray-700 btn-active-primary position-absolute translate-middle start-100 end-0 bottom-0 shadow-sm d-none d-lg-flex" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize" style="margin-bottom: 1.35rem; border: 2px dotted red; display:none !important;">
					...
					<div class="footer py-4 d-flex flex-lg-column d-none" id="kt_footer">
						...
						<div class="container-xxl d-flex flex-column flex-md-row flex-stack">
							...
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								<li class="menu-item">
									<a href="https://keenthemes.com" target="_blank" class="menu-link px-2">Política de Privacidade</a>
								</li>
								<li class="menu-item">
									<a href="https://keenthemes.com/support" target="_blank" class="menu-link px-2">Suporte</a>
								</li>
							</ul>
							<!--end:: Menu Footer -->
	...
	<script src="assets/js/custom/documentation/forms/flatpickr-locale-br.js"></script>
