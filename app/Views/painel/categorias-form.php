								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="categ_tolerancia">Tolerância de idade</label>
													<input type="text" name="categ_tolerancia" id="categ_tolerancia" class="form-control" value="<?php echo((isset($rs_dados->categ_tolerancia_idade) ? $rs_dados->categ_tolerancia_idade : ""));?>25%" />
												</div>
											</div>
											<div class="col-12 col-md-4">
												<?php 
													$user_ativo = (int)((isset($rs_edit->user_ativo) ? $rs_edit->user_ativo : "1")); 
													$media_s = ($user_ativo == "1" ? ' checked ' : '');
													$media_n = ($user_ativo != "1" ? ' checked ' : '');
												?>
												<div class="form-group">
													<div><label class="form-label" for="EMAIL">Média de Idade?</label></div>
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="user_ativo" id="ativo_s" class="custom-control-input" value="1" <?php echo($media_s)?> />
																<label class="custom-control-label" for="ativo_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="user_ativo" id="media_n" class="custom-control-input" value="0" <?php echo($media_n)?> />
																<label class="custom-control-label" for="media_n">Não</label>
															</div>
														</div>
													</div>
													<div><?php echo show_error($validation, 'user_ativo'); ?></div>
											...
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="categ_data">Data para Apresentação</label>
													<select class="form-select form-select-sm" name="categ_data" id="categ_data">
