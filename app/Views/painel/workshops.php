													...
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="d-flex justify-content-start flex-column">
																<a href="<?php echo($link_form); ?>" class="text-dark fw-bolder text-hover-primary "><?php echo($curso_titulo); ?></a>
																<span class="text-muted fw-bold text-muted d-block fs-7"><?php echo($curso_nome_professor); ?></span>
															</div>
														</div>
													</td>
													<td>
														<span class="text-dark text-hover-primary d-block fs-7"><?php echo($curso_local); ?></span>
