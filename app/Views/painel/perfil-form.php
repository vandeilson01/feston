								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Nome da Instituição</label>
										...
										<div class="row">
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Endereço</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
											<div class="col-12 col-md-3">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Número</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
											<div class="col-12 col-md-3">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Complemento</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-12 col-md-7">
												<div class="row">
													<div class="col-12 col-md-6">
														<div class="form-group">
															<label class="form-label" for="EMAIL">Bairro</label>
															<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
														</div>
													</div>
													<div class="col-12 col-md-6">
											...
											<div class="col-12 col-md-2">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Estado</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
										</div>
