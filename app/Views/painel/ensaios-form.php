								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Escala de Ensaios</label>
										...
										<div class="row">
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Hora Início</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Multiplicador</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
										</div>
