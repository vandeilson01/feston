								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('cursos/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													<thead>
														<tr>
															...
															<th style="width:250px;">Início / Término</th>
														</tr>
													</thead>
													<tbody>
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$link_form = painel_url('cursos/form/'. $curso_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey="<?php echo($curso_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo($curso_id); ?></td>
																<td style="line-height:1.25">
																	<div><strong><?php echo($curso_titulo); ?></strong></div>
																	<div><?php echo($curso_nome_professor); ?></div>
																</td>
																<td style="line-height:1.25">
																	<div class="d-flex">
																		<div><?php echo($curso_dte_inicio); ?> <?php echo($curso_hrs_inicio); ?></div>
																		<div style="margin-left: 8px;"><?php echo($curso_dte_termino); ?> <?php echo($curso_hrs_termino); ?></div>
																	</div>
																</td>
															</tr>
														<?php
