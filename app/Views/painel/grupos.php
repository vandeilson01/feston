								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('grupos/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$link_form = painel_url('grupos/form/'. $grp_id .'/params/grp:'. $grp_hashkey);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-codigo="<?php echo($grp_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																		<div style="margin: 0 3px;">
																			<!--
																			// feather
																			<a class="btn btn-sm btn-outline-secondary border me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete">	
																			<svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="16"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9zm7.5-5l-1-1h-5l-1 1H5v2h14V4h-3.5z"></path></svg> </a>
																			-->
																			<a href="#" class="border-btn" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="more-vertical"></i></a>
																			<div class="dropdown-menu dropdown-menu-start" style=""> 
																				<a class="dropdown-item" href="#"><i class="fe fe-edit-2 me-2"></i> Participantes</a> 
																				<a class="dropdown-item" href="#"><i class="fe fe-info me-2"></i> Coreografias</a> 
																			</div>
																		</div>
																	</div>
																</td>
																...
																<td>
																	<div style="line-height: 1.25"><?php echo($grp_titulo); ?></div>
																	<div style="line-height: 1.25"><?php echo($grp_responsavel); ?></div>
																</td>
															</tr>
														<?php
														}
