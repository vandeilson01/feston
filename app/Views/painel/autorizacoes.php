...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Termos e Autorizações</h2>
			</div>
		</div>
	</div>
												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															if($autz_parent_id == 0){
																$autz_titulo = '<strong>'. ($row->autz_titulo) .'</strong>';
															}
															$link_form = painel_url('autorizacoes/form/'. $autz_id);
														?>
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey ="<?php echo($autz_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo($autz_id); ?></td>
																<td>
																	<strong><?php echo($autz_titulo_parent); ?></strong>
																</td>
																<td>
																	<?php echo($autz_titulo); ?>
																</td>
															</tr>
														<?php
														}
