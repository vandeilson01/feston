...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Usuários : Administradores</h2>
			</div>
		</div>
	</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('administradores/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$link_form = painel_url('administradores/form/'. $user_id);
														?>
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		<div style="margin: 0 3px;">
																			<a href="<?php echo($link_form); ?>" class="btn btn-sm btn-ac btn-primary"><i class="las la-pencil-alt"></i></a>
																		</div>
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-codigo="<?php echo($user_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																		<div style="margin: 0 3px;">
																			<!--
																			// feather
																...
																<td>
																	<div><strong><?php echo($user_nome); ?></strong></div>
																</td>
