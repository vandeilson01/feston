								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('subgeneros')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="subgen_titulo">Título</label>
													<input type="text" name="subgen_titulo" id="subgen_titulo" class="form-control" value="<?php echo((isset($rs_dados->subgen_titulo) ? $rs_dados->subgen_titulo : ""));?>" />
												</div>
											</div>
											<div class="col-12 col-md-3">
												<div class="form-group">
													<label class="form-label" for="subgen_tempo_limit">Tempo</label>
													<input type="text" name="subgen_tempo_limit" id="subgen_tempo_limit" class="form-control" value="<?php echo((isset($rs_dados->subgen_tempo_limit) ? $rs_dados->subgen_tempo_limit : ""));?>" />
												</div>
											</div>
											<div class="col-12 col-md-3">
												<div class="form-group">
													<label class="form-label" for="subgen_tempo_limit">Max de Participantes</label>
													<input type="text" name="subgen_tempo_limit" id="subgen_tempo_limit" class="form-control" value="<?php echo((isset($rs_dados->subgen_tempo_limit) ? $rs_dados->subgen_tempo_limit : ""));?>" />
												</div>
											</div>
										</div>
