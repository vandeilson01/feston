								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('categorias')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="categ_idade_min">Idade Mínima</label>
													<input type="text" name="categ_idade_min" id="categ_idade_min" class="form-control" value="<?php echo((isset($rs_dados->categ_idade_min) ? $rs_dados->categ_idade_min : ""));?>" />
												</div>
											</div>
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="categ_idade_max">Idade Máxima</label>
													<input type="text" name="categ_idade_max" id="categ_idade_max" class="form-control" value="<?php echo((isset($rs_dados->categ_idade_max) ? $rs_dados->categ_idade_max : ""));?>" />
												</div>
											</div>
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="categ_tolerancia">Tolerência (em minutos)</label>
													<input type="text" name="categ_tolerancia" id="categ_tolerancia" class="form-control mask-minuto" value="<?php echo((isset($rs_dados->categ_tolerancia) ? $rs_dados->categ_tolerancia : ""));?>" />
												</div>
											</div>
										</div>
