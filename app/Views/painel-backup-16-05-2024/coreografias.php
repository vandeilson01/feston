								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('coreografias/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													<thead>
														<tr>
															...
															<th>Título</th>
															<th style="width:22%;">Coreógrafo / Música</th>
															<th style="width:22%;">Modalidade / Formato / Categoria</th>
														</tr>
													</thead>
													<tbody>
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$corgf_coreografo = ($row->corgf_coreografo);
															$corgf_musica = ($row->corgf_musica);
															$corgf_tempo = ($row->corgf_tempo);
															$musica = $corgf_musica . ( !empty($corgf_tempo) ? ' ('. $corgf_tempo .')' : '' ); 

															$link_form = painel_url('coreografias/form/'. $corgf_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdArquivarRegistro" data-codigo="<?php echo($corgf_id); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																...
																<td style="line-height: 1.25">
																	<div><strong><?php echo($corgf_coreografo); ?></strong></div>
																	<div><?php echo($musica); ?></div>
																</td>
																<td style="line-height: 1.25">
																	<div><strong><?php echo($modl_titulo); ?></strong></div>
																	<div><?php echo($formt_titulo); ?> / <?php echo($categ_titulo); ?></div>
																</td>
															</tr>
														<?php
														}
