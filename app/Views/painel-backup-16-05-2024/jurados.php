								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('jurados/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															$count++;
															$jurd_id = ($row->jurd_id);
															$jurd_hashkey = ($row->jurd_hashkey);
															$jurd_nome = ($row->jurd_nome);
															$jurd_email = ($row->jurd_email);

															$link_form = painel_url('jurados/form/'. $jurd_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-codigo="<?php echo($jurd_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																		<div style="margin: 0 3px;">
																			<!--
																			// feather
																...
																<td><?php echo($jurd_id); ?></td>
																<td>
																	<div><strong><?php echo($jurd_nome); ?></strong></div>
																</td>
																<td><?php echo($jurd_email); ?></td>
															</tr>
														<?php
														}
													?>
