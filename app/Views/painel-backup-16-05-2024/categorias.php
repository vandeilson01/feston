								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('categorias/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													<thead>
														<tr>
															...
															<th>Título</th>
															<th style="width:160px;">Idade (min/max)</th>
														</tr>
													</thead>
													<tbody>
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$categ_idade_min = ($row->categ_idade_min);
															$categ_idade_max = ($row->categ_idade_max);

															$link_form = painel_url('categorias/form/'. $categ_id);
														...
														?>
															<tr class="trRow">
																...
																<td><?php echo($categ_idade_min); ?> / <?php echo($categ_idade_max); ?></td>
															</tr>
														<?php
														}
													?>
