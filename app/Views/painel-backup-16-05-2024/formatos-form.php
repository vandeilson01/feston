								...
								<div class="row ">
									<div class="col-12 col-md-12">
										<div class="row justify-content-start align-items-center">
											...
											<div class="col-auto">
												<?php 
													$formt_ativo = (int)((isset($rs_edit->formt_ativo) ? $rs_edit->formt_ativo : "1")); 
										...
										<div class="row">
											...
											<div class="col-12 col-md-3">
												<div class="form-group">
													...
													<input type="text" name="formt_tempo_limit" id="formt_tempo_limit" class="form-control mask-minuto text-center" value="<?php echo((isset($rs_dados->formt_tempo_limit) ? $rs_dados->formt_tempo_limit : ""));?>" />
												</div>
											</div>
