								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('anuncios/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$link_form = painel_url('anuncios/form/'. $anunc_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey="<?php echo($anunc_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																		<div style="margin: 0 3px;">
																			...
																			<div class="dropdown-menu dropdown-menu-start" style=""> 
																				<a class="dropdown-item" href="<?php echo(site_url('participantes/'. $anunc_id)); ?>"><i class="fe fe-edit-2 me-2"></i> Participantes</a> 
																				<a class="dropdown-item" href="#"><i class="fe fe-info me-2"></i> Info</a> 
																			</div>
																		</div>
																	</div>
																</td>
																<td><?php echo($anunc_id); ?></td>
																<td><?php echo($anunc_titulo); ?></td>
															</tr>
														<?php
														}
													?>
