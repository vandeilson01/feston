								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('modalidades')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									<div class="col-12 col-md-3">
										...
										<div class="row">
											<div class="col-12">
												<?php 
													$modl_ativo = (int)((isset($rs_edit->modl_ativo) ? $rs_edit->modl_ativo : "1")); 
													$ativo_s = ($modl_ativo == "1" ? ' checked ' : '');
													$ativo_n = ($modl_ativo != "1" ? ' checked ' : '');
												?>
													...
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="modl_ativo" id="ativo_s" class="custom-control-input" value="1" <?php echo($ativo_s)?> />
																<label class="custom-control-label" for="ativo_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="modl_ativo" id="ativo_n" class="custom-control-input" value="0" <?php echo($ativo_n)?> />
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="modl_titulo">Título</label>
													<input type="text" name="modl_titulo" id="modl_titulo" class="form-control" value="<?php echo((isset($rs_dados->modl_titulo) ? $rs_dados->modl_titulo : ""));?>" />
												</div>
											</div>
										</div>
