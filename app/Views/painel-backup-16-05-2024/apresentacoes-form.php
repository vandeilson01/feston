								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Gênero</label>
													<select class="form-select" name="descricao" id="descricao">
														<option value="">- Selecione -</option>
														<option translate="no">- selecione -</option>
													</select>
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">SubGênero</label>
													<select class="form-select" name="descricao" id="descricao">
														<option value="">- Selecione -</option>
														<option translate="no">- selecione -</option>
													</select>
										...
										<div class="row">
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Programação / Sessão</label>
										...
										<div class="row">
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Limite de coreografias no mesmo Gênero Subgênero Categoria na Sessão</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Permitir que um mesmo Grupo dance o mesmo Gênero Subgênero Categoria</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Tempo máximo</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12 col-md-4">
												<div class="form-group">
													Verificar Limite de Intervalo de cada apresentação
													* possivelmente terei que rever.
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12 col-md-4">
												<div class="form-group">
													<label class="form-label" for="EMAIL">Tipo (Mostra / Competição)</label>
													<input type="text" name="EMAIL" id="EMAIL" class="form-control" value="" />
												</div>
											</div>
											<div class="col-12 col-md-4">
												<div class="form-group">
													<div><label class="form-label" for="EMAIL">Ensaio</label></div>
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="chkensaio" id="chkensaio_s" class="custom-control-input" value="1" checked />
																<label class="custom-control-label" for="ativo_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="chkensaio" id="chkensaio_n" class="custom-control-input" value="0" />
																<label class="custom-control-label" for="ativo_n">Não</label>
															</div>
														</div>
													</div>
											...
											<div class="col-12 col-md-4">
												<div class="form-group">
													<div><label class="form-label" for="EMAIL">Especial ( Não exibe no portal )</label></div>
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="chkespecial" id="chkespecial_s" class="custom-control-input" value="1" checked />
																<label class="custom-control-label" for="ativo_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="chkespecial" id="chkespecial_n" class="custom-control-input" value="0" />
																<label class="custom-control-label" for="ativo_n">Não</label>
															</div>
														</div>
													</div>
