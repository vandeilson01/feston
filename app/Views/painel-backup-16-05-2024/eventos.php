								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(painel_url('eventos/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$link_form = painel_url('eventos/form/'. $event_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey="<?php echo($event_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																		<div style="margin: 0 3px;">
																			...
																			<div class="dropdown-menu dropdown-menu-start" style=""> 
																				<a class="dropdown-item" href="<?php echo(site_url('participantes/'. $event_id)); ?>"><i class="fe fe-edit-2 me-2"></i> Participantes</a> 
																...
																<td>
																	<div style="line-height: 1.25;"><?php echo($event_data); ?></div>
																	<div style="line-height: 1.25;"><?php echo($event_hrs_ini); ?></div>
																</td>
															</tr>
														<?php
														}
			...
			$(document).on('click', '.cmdArquivarRegistro', function (e) {
				...
				Swal.fire({
					...
					if (result.value) {
						...
						$.ajax({
							url: painel_url  +'eventos/ajaxform/ARQUIVAR-REGISTRO',
							method:"POST",
							type: "POST",
							dataType: "json",
							data: $formData,
			...
			$(document).on('click', '.cmdExcluirRegistro', function (e) {
				...
				Swal.fire({
					...
					if (result.value) {
						// ------------------------------------------------------
						let $formData = {
							event_hashkey: $hashkey
						};

						$.ajax({
							url: painel_url  +'eventos/ajaxform/EXCLUIR-REGISTRO',
							method:"POST",
							type: "POST",
							dataType: "json",
							data: $formData,
