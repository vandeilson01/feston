													...
													<div class="container">
														<div class="row justify-content-center">
															<div class="col-11 col-md-11">
																...
																<div class="content-itens boxFields mt-3">
																	...
																	<div v-show="evcfg_config_limites.envio_musica == 1">
																		<div class="row">
																			...
																			<div class="col-12 col-md-auto" style="width: 20%;">
																				<div class="form-group">
																				...
																				<div class="col-12 col-md-12" v-for="(value, key, index) in lista_coreografos" >
																					<div class="card card-users oRDCorf" style="">
																						<div class="card-body p-0">
																							<div class="item mb-1" style="cursor: pointer;" :key="value.partc_id" @click="clickItemCheckboxChangeCor({partc_id : value.partc_id})"  :class="{ selecionado: selectedCoreografos.includes(value.partc_id) }">
																								<div class="row g-3 align-items-center">
																									...
																									<div class="col-12 col-md-1 text-center">
																										<div class="d-none"><input type="checkbox" 
																											:value='value.partc_id'	
																											v-model="fields.coreografia_elenco" 
																											@change="handleCheckboxChangeCor({partc_id : value.partc_id})" /></div>
																...
																<!-- ini : layout ANTIGO NÃO É MAIS EXIBIDO -->
																<div style="display:none;">
																<div class="row justify-content-center mt-4" v-show="lista_coreografos.length > 0">
																	<div class="col-12 col-md-12">
																...
																<div class="boxFields mt-4" v-show="fields.participantes_elenco.length > 0">
																	<div class="row justify-content-center">
																		<div class="col-12 col-md-12">
																			<h4 class="mb-2" style="color: #000000; font-size: 1.1rem; font-weight: bold;">Selecione o elenco de bailarinos</h4>
																		</div>
																		<div class="col-12 col-md-12">
																			<div class="row">
																				<div class="col-12 col-md-12" v-for="(value, key, index) in fields.participantes_elenco" :key="index">
																					<div class="card card-users oRDCorf" style="">
																						<div class="card-body p-0">
																							...
																							:class="{ selecionado: selectedItems.includes(value.partc_id) }"
																...
																<!-- // ini : novo layout NÃO É MAIS EXIBIDO -->
																<div style="display:none;">
																<div class="boxFields mt-4" v-show="fields.coreografia_elenco_all.length > 0">
																	<div class="row justify-content-center">
																		<div class="col-12 col-md-12">
																			<h4 class="mb-2" style="color: #000000; font-size: 1.1rem; font-weight: bold;">Elenco Selecionado</h4>
																		</div>
																		<div class="col-12 col-md-12">
																			<div class="row">
																				<div class="col-12 col-md-12" v-for="(value, key, index) in fields.coreografia_elenco_all" :key="index">
																					<div class="card card-users oRDCorf" style="">
																						<div class="card-body p-0">
																							<div class="item mb-1 selecionado">
																								<div class="row g-3 align-items-center">
																									...
																									<div class="col-12 col-md-auto">
																										<h4 class="mb-0" style="color: #FFFFFF !important;">{{index}} {{value.partc_nome}}</h4>
																										<div class="box-address justify-content-center">
																											<div class="" style="width: 100%">
																												<span class="local">CPF</span>
																												<span class="address">{{value.partc_documento}}</span>
																...
																<div class="boxFields mt-4" v-show="lista_corf_cadastradas.length > 0">
																	<div class="row justify-content-center">
																		<div class="col-12 col-md-12">
