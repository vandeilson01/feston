		...
		<div class="container">
			<div class="row pt-3 pb-5">
				<div class="col-12 col-md-12">
					...
					<FORM action="<?php echo(site_url('inscricoes/login/'. $event_hashkey)); ?>" method="post" name="formFieldsLogin" id="formFieldsLogin" >

					<div class="row justify-content-center align-items-start">
						<div class="col-12 col-md-5">

							<?php if( !empty(session()->getFlashdata('msg_inscricoes_login')) ){ ?>
								<div class="row">
									<div class="col-lg-12">
										<div class="alert alert-default alert-primary d-flex justify-content-between align-items-center" role="alert">
											<div class="d-flex align-items-center">
												<div style="margin-right: 10px;"><i class="fas fa-exclamation-triangle"></i></div>
												<div>
													<h4>Atenção!</h4>
													<?php echo( session()->getFlashdata('msg_inscricoes_login') ); ?>
												</div>
											</div>
							...
							<div class="card card-default" style="border-radius: 8px !important; border: 1.5px solid #e79c32 !important;">
								<div class="card-body">

									<div class="row justify-content-center">
										<div class="col-12 col-md-12">
											<h2 class="fw-bolder text-dark title-step mb-3" style="font-size: 1.5rem;">Informe seus dados para acesso</h2>
													...
													<div class="form-box">
														<div class="form-group"> 
															...
															<div class="input-group">
																<input type="password" id="user_senha" name="user_senha" class="form-control txtSenha fieldPassword" required="" value="" autocomplete="off" maxlength="30" />
																<span class="input-group-text" id="basic-addon2">
																	<i class="fas fa-eye togglePassword2" style="cursor:pointer;"></i>
																</span>
															</div>
														</div>
													</div>													
								...
								<div class="card-footer" style="background-color: rgba(0,0,0,0); border:0;">
									<div class="row justify-content-center">
										<div class="col-12 col-md-12">
											<div class="d-grid">
												<a href="<?php echo(site_url('inscricoes/cadastro/'. $event_hashkey)); ?>" class="btn btn-secondary shadow">Não tem cadastro? Clique aqui.</a>
											</div>
										</div>
									</div>
								</div>
