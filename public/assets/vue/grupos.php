																					...
																					<div class="personal-image">
																						<label class="label">
																							...
																							<figure class="personal-figure-grupo">
																								<div class="personal-avatar-grupo" style="background-image: url('assets/media/icon-profile2.png');"></div>
																							</figure>
																						</label>
																					</div>
																				</div>
																			...
																			<div class="item">
																				<div class="row justify-content-center align-items-center">
																					<div class="col-12 col-md-auto">
																						<a href="<?php echo( $link_participantes ); ?>"><div class="user-avatar-bg" style="background-image: url('assets/avatar/02.jpg');"></div></a>
																					</div>
																				...
																				<div style="position: absolute; bottom: 3px; right:6px">
																					<div class="d-flex justify-content-end">
																						<div style="margin: 2px 4px;">
																							<a href="javascript:;" class="icon-action"><i class="fas fa-pencil-alt"></i></a>
																						</div>
																						<!-- <div style="margin: 2px 4px;"> -->
															...
															<div class="col-11 col-md-12">
																		...
																		<div class="col-12 col-md-1" style="position: relative;">
																			<div class="boxAbsAvatar">
																				...
																				<div class="d-flex justify-content-end">
																					...
																					<div v-if="fields.grp_file_logotipo" class="bg-img-avatar full photo" v-bind:style="{ 'background-image': 'url(' + previewLogotipo + ')' }"></div>
																					<div v-else="">
																...
																<div class="content-actions">
																	<div class="row justify-content-end">
																		<div class="col-12 col-md-4">
																			<div class="d-grid">
																				<a href="javascript:;" class="btn btn-primary" v-on:click="salvarFormGrupo()" >Continuar</a>
																			</div>
																		</div>
																	</div>
																</div>
